package com.bigplex.bigplex.exceptions;
...
public class AppExceptionHandler extends ResponseEntityExceptionHandler {
    ...
    protected ResponseEntity<Object> handleMethodArgumentNotValid(
        ...
        ErrorDetails errorDetails =new ErrorDetails(new Date(),"Validation Error",details.toString());
    ...
    protected ResponseEntity<Object> handleHttpMediaTypeNotAcceptable(
        ...
        ErrorDetails errorDetails =new ErrorDetails(new Date(),"Media Type Not Acceptable", details.toString());
        return new ResponseEntity<>(errorDetails, status);
    }
    ...
    protected ResponseEntity<Object> handleHttpMessageNotReadable
        ...
        List<String> details = new ArrayList<>(Collections.singletonList(ex.getMessage()));
        ErrorDetails errorDetails =new ErrorDetails(new Date(),"Http Message Not Readable",details.toString());
        return new ResponseEntity<>(errorDetails, status);
    }
